...
public class Player extends FieldPieces
{
	...
	public Player(int x, int y, double diameter, boolean isCircle, boolean isWhite, String letter,
	...
	public void drawOn(Graphics2D g2)
	{
		if (this.isCircle)
		{
			...
			if (this.highlighted)
			{
				...
				shape.setFrame(this.xCenter - this.diameter / 2.0D - 1.0D, this.yCenter
						- this.diameter / 2.0D - 1.0D, this.diameter + 3.0D, this.diameter + 3.0D);
				g2.draw(shape);
				g2.setStroke(original);
			}
			shape.setFrame(this.xCenter - this.diameter / 2.0D,
					this.yCenter - this.diameter / 2.0D, this.diameter, this.diameter);
			...
			if (this.textEnabled)
			{
				...
				g2.drawString(this.letter, this.xCenter - m.stringWidth(this.letter) / 2,
	...
	public String toString()
	{
		if (this.textEnabled)
		{
			return "Player|" + this.xCenter + "|" + this.yCenter + "|" + this.diameter + "|"
					+ this.isCircle + "|" + isWhite() + "|" + this.letter;
		}
		return "Player|" + this.xCenter + "|" + this.yCenter + "|" + this.diameter + "|"
				+ this.isCircle + "|" + isWhite() + "|";
	}
