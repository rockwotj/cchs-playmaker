...
public class TextBox extends FieldPieces
{
	...
	public TextBox(int x, int y, Graphics2D g2, String text, String font, int size,
			String textColor, double width, double height)
	{
	...
	{
		return "TextBox|" + this.x + "|" + this.y + "|" + this.text + "|" + this.fontStyle + "|"
				+ this.size + "|" + getFontColor();
	}
