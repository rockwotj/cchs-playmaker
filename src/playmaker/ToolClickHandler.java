...
public class ToolClickHandler implements MouseListener
{
	...
	{
		if ((!this.toolBar.selection.isEnabled()) && (arg0.getClickCount() == 2)
	...
	public void mousePressed(MouseEvent arg0)
	{
		if ((SwingUtilities.isRightMouseButton(arg0))
				&& ((!this.toolBar.selection.isEnabled()) || (!this.toolBar.player.isEnabled())
						|| (!this.toolBar.misc.isEnabled()) || (!this.toolBar.zone.isEnabled())))
		{
			this.field.findPieceAt(arg0.getX(), arg0.getY());
			if (this.field.selected != null)
			{
		...
		{
			if ((this.timeToAddCurvedControlPoint > 1) && (!this.toolBar.add.isEnabled())
