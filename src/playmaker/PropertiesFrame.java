	...
	public static void textBoxPropertyFrame(final TextBox selected)
	{
		...
		okay.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				selected.setFontAndSizeAndText(fonts[font.getSelectedIndex()], text.getText(),
						inputedSize, g2);
	...
	public static void setDefaultsFrame()
	{
		...
		okay.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				{}
				Main.defaultTextColor = PropertiesFrame.getColorFromString(colors[fontColor
						.getSelectedIndex()]);
				Main.defaultIsCircle = isSquare.getSelectedIndex() == 0;
				Main.defaultIsWhite = isWhite.getSelectedIndex() == 0;
				Main.defaultZoneColor = PropertiesFrame.getColorFromString(zoneColors[zoneColor
						.getSelectedIndex()]);
				Main.setFrameTitle();
