...
import playmaker.fieldpieces.Zone;
 ...
 public class PopupMenu
 {
   ...
   public static void zonePopup(final Zone selected, int x, int y)
   {
     ...
     firstAction = true;
     zoneblue.addActionListener(new ActionListener()
     {
     ...
     zoneyellow.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     zonecyan.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     zonegold.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     zonered.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     zoneblack.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     zoneProperties.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
   ...
   public static void playerPopup(final Player selected, int x, int y)
   {
     ...
     firstAction = true;
     playeraddA.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playeraddB.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playeraddC.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playeradd1.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playeradd2.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playeradd3.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playeraddX.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playeraddY.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playeraddZ.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playercircle.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playersquare.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playerwhite.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     playerproperties.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
   ...
   public static void textBoxPopup(final TextBox selected, int x, int y)
   {
     ...
     firstAction = true;
     textProperties.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     textwhite.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     textluc.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
     ...
     textgeo.addActionListener(new ActionListener()
     {
       public void actionPerformed(ActionEvent arg0)
       {
         if (PopupMenu.firstAction)
