...
public class SelectionMotionHandler implements MouseMotionListener
{
	...
	public SelectionMotionHandler(DrawingField field, ToolBar optionToolBar,
			ToolClickHandler clickHandler)
	{
			...
			if (!this.toolBar.selection.isEnabled())
			{
				if (this.field.selected != null)
				{
					...
					|| (((!this.toolBar.arrowhead.isEnabled())
							|| (!this.toolBar.blockhead.isEnabled()) || ((!this.toolBar.add
							.isEnabled()) && (this.toolBar.lines.getSelectedIndex() == 2))) && (this.field.selected != null)))
			{
	...
	{
		if ((!this.toolBar.add.isEnabled()) && (this.toolBar.lines.getSelectedIndex() == 3)
				&& (this.field.selected != null) && ((this.field.selected instanceof CurvedLine)))
		{
